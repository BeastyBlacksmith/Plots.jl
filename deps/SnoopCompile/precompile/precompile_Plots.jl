...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(_backend_instance),Symbol})
    ...
    Base.precompile(Tuple{typeof(gr_draw_markers),Series,StepRangeLen{Float64, Base.TwicePrecision{Float64}, Base.TwicePrecision{Float64}},Vector{Float64},Tuple{Float64, Float64},Int64,Int64})
